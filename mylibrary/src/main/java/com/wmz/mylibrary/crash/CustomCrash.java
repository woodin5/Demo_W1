package com.wmz.mylibrary.crash;
...
import com.wmz.mylibrary.utils.DeviceUtil;
...
public class CustomCrash  implements Thread.UncaughtExceptionHandler{
    ...
    private static final String CRASH_SAVE_SDPATH="sdcard/crash/"; //崩溃日志SD卡保存路径
...
//                }
    ...
    private String getExceptionInfo(Throwable ex) {
        ...
        stringBuffer.append("SystemVersion:"+ DeviceUtil.getLocalSystemVersion()+"\n");
