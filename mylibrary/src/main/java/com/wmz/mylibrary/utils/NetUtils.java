...
public class NetUtils {
    ...
    public static boolean hasDataConnection(Context var0) {
        try {
            ...
            if(var2 != null && var2.isAvailable() && var2.isConnected()) {
                WMZLog.d("net", "has wifi connection");
                return true;
            } else {
                var2 = var1.getNetworkInfo(0);
                if(var2 != null && var2.isAvailable() && var2.isConnected()) {
                    WMZLog.d("net", "has mobile connection");
                    return true;
                } else {
                    if(VERSION.SDK_INT >= 13) {
                        var2 = var1.getNetworkInfo(9);
                        if(var2 != null && var2.isAvailable() && var2.isConnected()) {
                            WMZLog.d("net", "has ethernet connection");
                            return true;
                        }
                    }

                    WMZLog.d("net", "no data connection");
                    return false;
                }
            }
    ...
    public static boolean isWifiConnection(Context var0) {
        ...
        NetworkInfo var2 = var1.getNetworkInfo(1);
        if(var2 != null && var2.isAvailable() && var2.isConnected()) {
            WMZLog.d("net", "wifi is connected");
            return true;
        } else {
            return false;
        }
    ...
    public static boolean isMobileConnection(Context var0) {
        ...
        if(var2 != null && var2.isAvailable() && var2.isConnected()) {
            WMZLog.d("net", "mobile is connected");
            return true;
        } else {
            return false;
        }
    ...
    public static boolean isEthernetConnection(Context var0) {
        if(VERSION.SDK_INT < 13) {
            ...
            if(var2 != null && var2.isAvailable() && var2.isConnected()) {
                WMZLog.d("net", "ethernet is connected");
                return true;
            } else {
                return false;
            }
