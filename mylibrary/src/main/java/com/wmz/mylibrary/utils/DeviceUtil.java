...
public class DeviceUtil {
    ...
    public static int getIpAddress(Context context) {
        ...
        WifiInfo wifiInfo = null;//wifiManager.getConnectionInfo();
    ...
    public static String getRatingColorString(String vote) {
        StringBuffer sb = new StringBuffer();
        if (vote == null || vote.equals("") || !FloatUtils.isFloat(vote)) {
            vote = "0";
        }
    ...
    public static String getBpSetRetryUrl(String retryName, String sourceStr) {
        String retryUrl = DeviceUtil.replaceRealmName(retryName,
    ...
    public static String getBpPlayRetryUrl(String retryName, String sourceStr) {
        String retryUrl = DeviceUtil.replaceRealmName(retryName, "dp.ugc.pps.tv",
                sourceStr);
        return retryUrl;
    }
